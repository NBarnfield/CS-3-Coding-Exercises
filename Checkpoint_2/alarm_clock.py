...
#         tomorrow = int(input("What day is it tomorrow 0-6 where {} ? ".format(week)))
#
#         if tomorrow in range(0, 7):
#             break
#
#         else:
...
#
#         else:
#             print("That is not a valid answer. Please enter True or False.")
#
#     except ValueError:
...
vacation = true_false("Are you on holiday?")


if vacation is True:
    print("Yay, you're on vacation")
else:
    print("Oh no, that's a shame!")
